...
interface IAuditLogsUpcomingEventsProps {
	isFluid?: boolean;
}
const AuditLogsUpcomingEvents: FC<IAuditLogsUpcomingEventsProps> = ({ isFluid }) => {
	...
	const { items, requestSort, getClassNamesFor } = useSortableData(auditLogs);
	const formattedNow = now.format('YYYY-MM-DD , hh:mm a');
									...
									<td>
										<div className='d-flex align-items-center'>
											<span
												...
												<span className='visually-hidden'>{item.user}</span>
											</span>
											<span className='text-nowrap'>{formattedNow}</span>
										</div>
									</td>
...
export default AuditLogsUpcomingEvents;
