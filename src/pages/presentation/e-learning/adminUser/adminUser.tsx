...
const AdminUserPage = () => {
	...
	const { id } = useParams();
	const itemData = adminUser.filter((item) => item.id.toString() === id?.toString());
	...
	return (
		<PageWrapper className='mt-3' title={demoPagesMenu.crm.subMenu.customer.text} isProtected={true}>
			<SubHeader>
				<SubHeaderLeft>
					<Button
						color='primary'
