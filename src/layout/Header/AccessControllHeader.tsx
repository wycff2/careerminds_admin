...
interface IAccessControllHeaderLeftProps {
	children: ReactNode;
	className?: string;
}
export const AccessControllHeaderLeft: FC<IAccessControllHeaderLeftProps> = ({ children, className }) => {
	return <div className={classNames('header-left', 'col-md', className)}>{children}</div>;
};
AccessControllHeaderLeft.propTypes = {
	children: PropTypes.node.isRequired,
	className: PropTypes.string,
};
AccessControllHeaderLeft.defaultProps = {
	className: undefined,
};
...
interface IHeaderProps {
	children: ReactElement<IAccessControllHeaderLeftProps> | ReactElement<IHeaderRightProps> | ReactNode;
